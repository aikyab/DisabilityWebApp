  ...
  return (
    ...
    <div className="container px-4 px-lg-5" style={{padding: "100px"}}>
        ...
        <div className="row gx-4 gx-lg-5 align-items-center my-5">
            <div className="col-lg-7"><img className="img-fluid rounded mb-4 mb-lg-0" src="https://i.imgur.com/aKVQp96.jpg" alt="..."/></div>
        ...
        <div style={{backgroundColor: "lightgrey"}}>
            ...
            <div className="container px-4 px-lg-5" style={{padding: "100px"}}>
                <div className="row gx-4 gx-lg-5 align-items-center my-5">
                    ...
                    <div className="col-lg-7"><img className="img-fluid rounded mb-4 mb-lg-0" src="https://i.imgur.com/XBhOaJg.jpg" alt="..."/></div>
                </div>
            </div>
